var urlRoute = {
    ...
    checkCurrent: function(e) {
        if (this.baseUrl != document.URL) {
            document.URL;
            var t = document.URL.replace("https://imaginears.club/hub/appeal/", "");
            this.loadPage(t);
        } else this.loadPage("Punishments.Appeal")
    },
    loadPage: function(e) {
        ...
        console.log(e);
        if (e == "/") {
          e = "/Punishments.Appeal";
        }
        var t = e.split("."),
            o = t[1].split("?");
        if (null == o[1]) r = "Punishments";
        else var r = o[1];
    ...
    pageError: function() {
      urlRoute.loadPage("Punishments.Appeal")
      toastr.options = {
        "closeButton": true,
        "debug": false,
        "newestOnTop": false,
