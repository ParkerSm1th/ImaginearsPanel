    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                <a class="logo-box web-page" href="Punishments.Appeal"><img src="https://imaginears.club/wp-content/uploads/2018/07/logoexexsmallwhite.png"></a>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="navbar-header">
                                <div class="logo-sm">
                                    ...
                                    <a href="Punishments.Appeal" class="web-page logo-box"><span>Imaginears</span></a>
                                </div>
        ...
        <script>
          urlRoute
            .folderUrl('/hub/appeal')
            .setBaseUrl('https://imaginears.club/hub/appeal/')
            .checkCurrent('https://imaginears.club/hub/appeal/');
        </script>
    </body>
</html>
