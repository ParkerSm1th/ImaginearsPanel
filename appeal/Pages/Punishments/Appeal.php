...
$_SESSION['appeal']['discord'] = $discord;
$_SESSION['appeal']['discordID'] = $discordID;
 ?>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <?php
                                                if ($discordID != null) {
                                                  ?>
                                                    <input type="text" value="<?php echo $discord ?>" disabled class="form-control" name="discord" id="discord">
                                                  <?php
                                                } else {
                                                  ?>
                                                    <input type="text" class="form-control" name="discord" id="discord">
                                                  <?php
                                                }
                                              ?>
