...
<div class="page-title">
    <h3 class="breadcrumb-header">Your Application</h3>
</div>
<div class="row">
  <div class="col-md-12">
          ...
          <div class="panel-body">
              <div id="rootwizard">
                  <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li role="presentation"><a href="#tab4" data-toggle="tab"><i class="fa fa-comment m-r-xs"></i>Comments</a></li>
                  </ul>
                          ...
                          <div class="tab-pane fade" id="tab4">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <?php if ($applicationDetails['comments'] == "") {
                                      ?>
                                      <textarea disabled value="" id="comments" name="comments" class="form-control" style="resize: none; " rows="4">No comments yet</textarea>
                                      <?php
                                    } else {
                                      ?>
                                    <textarea disabled value="" id="comments" name="comments" class="form-control" style="resize: none; " rows="4"><?php echo $applicationDetails['comments']?></textarea>
                                  <?php } ?>
                                </div>
                            </div>
                          </div>
