...
$id = $_GET['id'];
$applicationDetails = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM `panel`.`applications` WHERE id = '$id'"));
...
<div class="page-title">
    <h3 class="breadcrumb-header">View Application</h3>
</div>
<div class="row">
  <div class="col-md-12">
                              ...
                              <?php } else if ($applicationDetails['a_role'] == 'Developer') { ?>
                                ...
                                <?php } else if ($applicationDetails['a_role'] == 'Imagineer') { ?>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <textarea disabled value="" id="im3" name="im3" class="form-control" style="resize: none; " rows="4"><?php echo $applicationDetails['i_showcase']?></textarea>
                                  </div>
                                  <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea value="" id="comment" name="comment" class="form-control" style="resize: none; " rows="4"><?php echo $applicationDetails['comments']?></textarea>
                                </div>
                                <a href="#" class="btn btn-default" id="updateComment" style="margin-bottom: 20px;">Update Comment</a><br>
                                <div class="form-group">
                                    <label for="gr4">Staff Comments (Can't be seen by applicant)</label>
                                    <textarea value="" id="staff_comment" name="staff_comment" class="form-control" style="resize: none; " rows="4"><?php echo $applicationDetails['staff_comments']?></textarea>
                                </div>
                                <a href="#" class="btn btn-default" id="updateStaffComment" style="margin-bottom: 20px;">Update Staff Comment</a><br>
                                <a href="#" class="btn btn-danger" id="deny" style="margin-bottom: 20px;">Set Application as Denied</a>
                                <a href="#" class="btn btn-success" id="accept" style="margin-bottom: 20px;">Set Application as Accepted</a>
                                <a href="#" class="btn btn-info" id="pending" style="margin-bottom: 20px;">Set Application as Pending</a><br><br>
                                <a href="#" class="btn btn-danger" id="delete" style="margin-bottom: 20px; font-weight: 500;"><strong>Archive Application</strong></a>
                              </div>
                            </div>
                          </div>
                      </div>
